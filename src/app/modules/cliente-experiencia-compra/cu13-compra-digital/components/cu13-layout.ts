...
@Component({ selector: 'app-cu13-layout', imports: [RouterLink], host: { '[class.plain]': 'plain()' },
  template: `<section aria-labelledby="cu13-title">
    <nav aria-label="Tienda"><a routerLink="/tienda">Catálogo</a> · <a routerLink="/tienda/carrito">Carrito</a></nav>
    <h1 id="cu13-title">{{ title() }}</h1>

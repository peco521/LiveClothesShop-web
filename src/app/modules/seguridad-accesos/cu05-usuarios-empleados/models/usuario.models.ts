...
export interface EmpleadoDatos {
  ...
  nroRol: string; cargo: string; nroSuc: number;
}
...
export interface EmpleadoOpciones { roles: RolOpcion[]; ciudades: CiudadOpcion[]; sucursales: SucursalOpcion[]; proximoCodigo?: string }
